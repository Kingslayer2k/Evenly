...
- Supabase (auth + db)
- Vercel (deployment)
- Custom components: GroupCard.js, CreateGroupModal.js, BottomNav.js, etc.
- NO shadcn, NO MUI, NO Chakra — all custom

## Styling rules
- Tailwind 4 utility classes for layout/styling
- Global CSS variables in app.css for theming (--primary, --ink, --muted, etc.)
- Dark/light theme via html[data-theme="dark/light"]
- Framer Motion for animations — keep consistent with existing motion patterns
