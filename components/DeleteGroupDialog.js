      ...
      >
        ...
        <div className="mt-6 flex gap-3">
          ...
          <button
            ...
            onClick={onConfirm}
            disabled={isDeleting}
            className="h-11 flex-1 rounded-[10px] bg-[var(--danger)] text-[15px] font-medium text-white transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60"
          >
